---
name: GradedArraysNext.jl bug report
about: Create a bug report to help us improve GradedArraysNext.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("GradedArraysNext")`:
```julia
julia> using Pkg; Pkg.status("GradedArraysNext")
[YOUR OUTPUT HERE]
```
